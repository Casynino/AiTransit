...
export async function profitAndLoss(window: ProfitWindow) {
  ...
  /*
    ...
    bank account, kwacha on the other five.

    Summing them in SQL and dividing the total by the USD→ZMW rate produced a
    figure in neither currency — a USD 25 wire fee beside a K 5,000 mobile
    ...
    fee is converted on its own now, and only a kwacha fee with no published
