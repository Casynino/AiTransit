...
/**
 * What is physically standing in the Lusaka warehouse right now.
 *
 ...
 *
 * "Right now" is exactly two statuses. RECEIVED_AT_ZAMBIA is checked in off the
...
/** Cargo the Lusaka warehouse is holding. The one definition, used everywhere. */
...
/**
 * How long each consignment has been standing on the Lusaka floor.
 *
 ...
 *
 * Lusaka's ON_THE_FLOOR has a matching job here, and for the same reason — the
