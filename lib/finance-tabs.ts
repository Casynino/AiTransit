  ...
  return [
    ...
    },
    {
      /*
        ...
        the admin agrees it without writing the figures.
      */
    ...
    {
      /*
        AITRANSIT's second line of business, given a tab rather than a link
        buried on the overview. Currency and supplier payments are a daily job
        for the same desk that records customer payments, and a workspace that
        did not offer them would send that desk to the URL bar every morning.
      */
      href: "/app/finance/exchange",
      label: "Money desk",
      visible: can(role, "fx.manage"),
    },
    {
    ...
    /* No Closed batches tab. The owner: "i dont want the closed batch to be
       ...
       Operations for the admin, beside the ledger for Finance and the owner.
