 ...
 * ZMW 5,000 taxi fare through an approval queue stops using the system by
 ...
 * operation between Guangzhou and Lusaka pays over and over, so they are one tap:
 ...
 * cleared at Zanzibar or at Lusaka, it may need a permit at either, it is trucked
 * from Zanzibar to Lusaka, and it is trucked from the port to the warehouse.
 *
