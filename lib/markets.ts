...
export const MARKETS: Market[] = [
  {
    ...
    tips: [
      ...
      "Goods bought here normally consolidate through Guangzhou for the flight to Lusaka.",
    ],
  },
  {
    ...
    summary:
      "Not one market but a cluster across the city, each with its own speciality: Baiyun for leather and bags, Shahe and Thirteen Hang for clothing, Zhanxi for wholesale fashion. This is where most Zambian traders buy.",
    products: [
  ...
  },
  {
    ...
    summary:
      "The clothing market Guangzhou is known for, and the one most Zambian fashion traders end up in. Baima sells finished garments rather than fabric, and the quality sits noticeably above the cheaper markets around the station.",
    products: [
  ...
  },
  {
    ...
    tips: [
      "Test everything at the stall. A screen or a battery that fails is not something you can return from Lusaka.",
  ...
  },
  {
    ...
    summary:
      "Streets of parts shops organised loosely by system — body panels in one area, electrical in another. Strongest on the Japanese and Chinese models most common on Zambian roads.",
    products: [
  ...
  },
  {
    ...
    tips: [
      ...
      "Check the voltage. Zambia runs 230V and a great deal of stock here is made for other markets.",
      "Solar lighting sells well in Zambia but quality varies enormously. Buy a sample and leave it in the sun for a week before ordering.",
    ],
  },
  {
  ...
  },
  {
    ...
    tips: [
      ...
      "Packaging is bulky and cheap, which makes it the worst possible thing to air freight. Consider buying it locally in Lusaka unless it is genuinely unavailable.",
