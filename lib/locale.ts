 ...
 *
 * Two languages, deliberately. The staff app is English and Chinese — Lusaka
 * and Guangzhou. The customer-facing site is English only and is a separate
 * concern with separate copy; mixing the two would put a half-translated staff
 * interface in front of customers.
 */
 ...
 * not a staff language reads as English, which is the default every Zambian
 * desk works in.
 */
