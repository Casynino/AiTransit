...
/**
 * THE ADMIN'S RECONCILIATION WORKSPACE, ON THE BOOKS THE BUSINESS ALREADY HAS.
 *
 ...
 * stores a second copy of one: a verdict is an append-only RecordReview beside
 ...
 * typed by the admin, stored with the ledger's own figure frozen beside it,
 ...
 * totals of the CURRENT FILTERS, so "this week, the bank account, still pending" states its
