 ...
 * USD → ZMW.
 *
 * Prices are quoted in USD; almost everyone pays in kwacha. Two rules govern
 * everything here:
 *
 ...
 *     because a customer who was told "ZMW 202,500" must still see that figure
...
/*
  ...
  Promise.all, and the admin's home adds more — each one an identical query.
