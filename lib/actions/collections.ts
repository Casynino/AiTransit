 ...
 * collects the customer's evidence — the mobile-money screenshot, the bank slip — and
 * hands it up. Nothing they do moves a kwacha: a submission is a claim, and
...
export async function verifyPaymentSubmission(
  ...
  /*
    The row is claimed before a kwacha moves.
