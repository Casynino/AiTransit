 ...
 * CUSTOMER_CARE, and a Admin added later silently stopped being told that
...
async function openOrAppendLossCase(
  ...
  // "Received at Lusaka warehouse", its boxes ticked, sitting in Inventory — while
 ...
 * data.
 *
 * Gated on `exception.raise`, which the Lusaka floor, Support, Finance and the CEO
