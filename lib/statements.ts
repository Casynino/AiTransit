 ...
 * control on the closed-batches sheet — but it existed nowhere the admin
 ...
 * point of a statement is that the admin reads the same numbers the day it
...
export type WaitingStatement = {
  ...
  /** The rate on the day it was closed, so the kwacha never move again. */
  rate: number | null;
};
 ...
 * frozen kwacha figure: those rates differ by weeks, and a total struck
