 ...
 *    it can.
 *  - Everything else returns to RECEIVED_AT_ZAMBIA. Somebody is standing in the
 *    Lusaka warehouse holding the cargo — that is what "found" means — so
...
export function restoredStatus(
  ...
  return previous === "READY_FOR_PICKUP" ? "READY_FOR_PICKUP" : "RECEIVED_AT_ZAMBIA";
}
 ...
 * Lusaka floor needs that much to answer a customer at the counter, and none of it
 * is a price.
 */
