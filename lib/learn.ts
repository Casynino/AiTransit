...
export const ARTICLES: Article[] = [
  {
    ...
    summary:
      "From your supplier's shop to the counter in Lusaka — the eight steps your boxes go through, and who is responsible at each one.",
    readMinutes: 5,
    category: "Getting started",
    body: [
      {
        kind: "p",
        text: "Most people importing for the first time picture one long journey: goods leave China, goods arrive in Zambia. In practice your cargo changes hands several times, and knowing where those handovers are is what lets you tell a delay from a disaster.",
      },
      ...
      {
        kind: "p",
        text: "In Lusaka the whole batch is checked piece by piece against a printed list. Anything missing is flagged there and then, not discovered three weeks later when somebody comes to collect.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        kind: "p",
        text: "We inspect cargo at our Guangzhou warehouse and photograph it. It is far cheaper to reject something in China than to discover it in Lusaka, where your options are to accept it or to have paid freight on goods you cannot sell.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Paying a Chinese supplier from Zambia",
    summary:
    ...
    body: [
      {
        kind: "p",
        text: "Getting money from Zambia to a supplier in Guangzhou is often harder than getting the goods back. These are the routes people actually use.",
      },
  ...
  },
  {
    ...
    body: [
      {
        kind: "p",
        text: "Customs is the part of the journey nobody can promise a time for, and the part where mistakes made in China become expensive in Zambia.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "h", text: "Before you buy" },
      {
        kind: "list",
        items: [
          "Work out what a competitor sells the same item for in Lusaka. If freight plus purchase price is close to that, the order does not work — find out now.",
