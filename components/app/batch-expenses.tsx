 ...
 * kwacha, say which account it left. No chips to tap first and no form to
 ...
 *
 * Kwacha lead throughout. The office pays the clearing agent in kwacha;
...
export function BatchExpenses({
  ...
  /** USD → ZMW, for showing a dollar cost in kwacha. Null if unpublished. */
  rate: number | null;
  canRecord: boolean;
  ...
  /*
    ...
    scrolling is the part worth arguing about. The twelve-thousand-kwacha
            ...
            <div className="group flex h-10 items-center gap-x-3 px-5 text-sm transition-colors hover:bg-muted/20">
              ...
              */}
              ...
              <span className="flex min-w-0 flex-1 items-baseline gap-2">
                ...
                {/* A cost paid in dollars: say so, since the column is kwacha. */}
                {e.currency !== "ZMW" ? (
      ...
      {closed ? (
        ...
        >
          ...
          {/*
            ...
            page whose subject is a twenty-million kwacha batch. Recording a
      ...
      <form action={edit} className="flex flex-wrap items-end gap-2">
        ...
        */}
        ...
        {/*
          ...
          actually left the bank, as often as it gets a digit wrong — and having to
        ...
        */}
        {/*
          ...
          customs", "Transport · Zanzibar to Lusaka". One list, so a cost entered
