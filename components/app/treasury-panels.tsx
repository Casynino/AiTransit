...
/**
 * "Bank account (ZMW)" already says which currency it is. Appending it again reads
...
/**
 * Banking the cash, funding the tin, moving dollars into kwacha.
 *
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <Label htmlFor="amountOut" className="text-xs">
              ...
              {fromAccount ? (
                <span className="text-muted-foreground">
                  ({fromAccount.currency === "ZMW" ? "K" : fromAccount.currency})
                </span>
              ) : null}
            </Label>
          ...
          <div className="space-y-1.5">
            {/*
              ...
              while the one beside it did, so on a dollars-into-kwacha move
      ...
      <form action={action} className="space-y-3 p-5">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="countedAmount" className="text-xs">
            ...
            {account ? (
              <span className="text-muted-foreground">
                ({account.currency === "ZMW" ? "K" : account.currency})
              </span>
            ) : null}
          </Label>
          <MoneyInput
