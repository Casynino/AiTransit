...
const PARENTS: { prefix: string; parent: string; label: string }[] = [
  ...
  /* Deliberately NOT /app/admin/settings. Settings is settings.manage, the
     ...
     admin backing out of Deleted records was posted at a door their own
  ...
  /* Narrower first — the matcher takes the first row whose prefix fits, so a
     ...
     above it. */
  { prefix: "/app/admin", parent: "/app/admin", label: "Command centre" },
...
const ROOTS = new Set([
  ...
  /*
    ...
    It is the third icon on the Guangzhou bar and the Lusaka bar, so a clerk opens
    ...
    most: Guangzhou never touches arrived batches at all, that is the Lusaka floor's
  ...
  */
  ...
  /*
    ...
    fourth tab, and its label sent that desk to a Lusaka screen.
  */
  "/app/shipments",
  "/app/batches",
  "/app/finance",
