    ...
    <>
      ...
      */}
          ...
          <dl className="mt-1.5 grid grid-cols-2 gap-x-4 gap-y-1.5 text-sm font-medium">
            {[
              ...
              /* "Billed" rather than the table's "$": the figure leads in
                 kwacha here, so a dollar sign over it would mislabel it. */
        ...
        <table className="w-full min-w-[1320px] text-sm">
          ...
          <tfoot>
            <tr className="border-t-2 bg-muted/30 font-semibold">
              ...
              {/* One cell across the $ and ZMW pair: the rows' ZMW column sums
      ...
      <p className="mt-2 text-xs text-muted-foreground">
        {t(
          "Each row is frozen at the day its batch closed, including the exchange rate. The Total row's kwacha are priced at today's published rate, and its per-kilo rates are weighted across the period, not column sums."
        )}
      </p>
