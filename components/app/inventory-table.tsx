...
/**
 * One piece of cargo standing on the Lusaka warehouse floor.
 *
...
export type InventoryRow = {
  ...
  status: "RECEIVED_AT_ZAMBIA" | "READY_FOR_PICKUP";
  customerName: string;
  ...
  packages: number;
  packageType: string;
  /** Packages on the manifest that have not been ticked off in Lusaka. */
