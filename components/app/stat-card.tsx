  ...
  const body = (
    ...
    >
      ...
      {/*
        ...
        A fixed text-2xl fits "K 1,476,765" and runs off the edge of its own
        card at "K -37,932,246" — and a money headline that silently drops its
        last digits is worse than a slightly smaller one. Same rule as the
        finance overview band; kwacha are simply longer than dollars, so the
