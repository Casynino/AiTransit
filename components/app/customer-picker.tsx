...
import { ZM_CITIES } from "@/lib/constants";
      ...
      {mode === "search" ? (
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder={t(locale, "Mama Zainab, 0977 000 111 or CUS-000123")}
              className="pl-9"
              autoComplete="off"
            />
            {searching ? (
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="new-city">{t(locale, "City in Zambia")}</Label>
              <Input
                id="new-city"
                value={city}
                onChange={(event) => setCity(event.target.value)}
                list="tz-cities"
                placeholder={t(locale, "Lusaka")}
              />
              <datalist id="tz-cities">
                {ZM_CITIES.map((option) => (
