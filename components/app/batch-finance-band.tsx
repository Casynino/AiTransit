...
import { formatLocal, formatKwacha, formatUsd } from "@/lib/fx";
...
export async function BatchFinanceBand({
  ...
  /* One converter, not a ternary per figure — the house rule, and the reason the
     ledger once led in kwacha while the profit page beside it led in dollars.
        ...
        {([
          ...
          <div key={cell.k} className="bg-card px-5 py-3">
            ...
            {/*
              ...
              The office quotes, pays and banks in kwacha all day; the dollar
