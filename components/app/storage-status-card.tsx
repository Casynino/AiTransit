...
import { formatKwacha } from "@/lib/fx";
...
export function StorageStatusCard({
  ...
  locale: Locale;
  /** USD → ZMW, so the fee reads in the money the customer will hand over. */
  rate: number | null;
  decision?: {
    invoiceId: string;
    chargedUsd: number;
      ...
      <div className="border-t px-4 py-2.5">
        <p className="flex items-baseline justify-between gap-2 text-sm">
          ...
          {/*
            ...
            This led with a running kwacha figure on every screen that showed a
