 ...
 *
 * Deliberately no money. The Lusaka floor investigates cargo; what the customer
        ...
        <Field icon={Warehouse} label={t(locale, "Where the cargo is")}>
          <p className="text-sm font-medium tabular">
            {total === 0
              ...
              : `${onFloor} ${t(locale, "of")} ${total} ${t(locale, total === 1 ? unit.one : unit.many)} ${t(locale, "checked in at Lusaka")}`}
          </p>
          ...
          {absent.length > 0 ? (
            ...
            <p className="mt-1.5 text-xs text-muted-foreground">
              {collected > 0
                ...
                : `${t(locale, "Every")} ${t(locale, unit.one)} ${t(locale, "is in the Lusaka warehouse.")}`}
            </p>
          ) : null}
