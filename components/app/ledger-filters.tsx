 ...
 * each other — "look at what went through the the bank account last month" — and
    ...
    <div className="mb-4 rounded-xl border bg-card p-4">
      <div className="relative">
        ...
        <Input
          ...
          placeholder={t(
            "Customer, tracking number, receipt, mobile money reference, cargo, vendor, account, person…"
          )}
          className="pl-9"
