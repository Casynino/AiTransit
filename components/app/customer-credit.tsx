  ...
  */
  ...
  const cells: { k: string; v: string; tone: string; hint?: string | null }[] = [
    ...
    },
    {
      ...
      v: lastPayment
        ? formatKwacha(lastPayment.usd, lastPayment.rate ?? rate)
        : t("Never"),
            ...
            >
              <div className="flex items-baseline justify-between gap-3">
                ...
                <p className="shrink-0 text-right">
                  ...
                  >
                    {/* This bill's own frozen rate. A customer told K 202,500
                        must still read K 202,500 in six months. */}
                    {formatKwacha(r.outstandingUsd, r.exchangeRate ?? rate)}
                  </span>
        ...
        <p className="text-[11px] text-warning">
          ...
          {outstandingUsd > 0.005 ? (
            <span className="font-semibold">
              {" "}
              {formatKwacha(outstandingUsd, rate)}{" "}
