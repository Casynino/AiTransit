...
/**
 * The admin's command centre, as furniture.
 *
 * WHY THIS FILE EXISTS. The admin's screen was a flat grid of identical small
 ...
 * set at 15px in a grid of forty others is a table cell; a admin reads a
...
export type AccountRow = {
  ...
  colour: string;
  /** Formatted in the account's OWN currency — never restated in kwacha. */
  display: string;
 ...
 * bank at K -9,505,180 as "0%" and K 20,000 of mobile money as "100%" of
 ...
 *
 * THE SECOND LINE IS THE ADMIN'S ACTUAL JOB. A balance nobody has reconciled
 ...
 * page prints as its headline — Guangzhou standing, the Lusaka floor, cleared and
 ...
 * leads in kwacha. This draws the shape and states the two year totals in
