 ...
 *
 * AITRANSIT adds two rows Target Express had no need of. "Exchange" is the
 * second line of business and belongs in the top row rather than three clicks
 * down; "Calculator" is the question every first-time customer asks and the
 * rate card alone does not answer it for a specific parcel. Two of the old
 * rows earn their place less on this site and are reachable from the pages
 * that matter — but nothing was removed, because a missing row is a page
 * nobody finds.
 */
const NAV = [
  { href: "/pricing", label: "Rates" },
  { href: "/calculator", label: "Calculator" },
  // The money desk. Second only to the rates, because it is the second half of
  // what AITRANSIT sells and a visitor looking for it should not have to guess
  // which page it hides on.
      ...
      <div className="container">
        <nav className="flex items-center justify-between py-3 md:py-4">
          <div className="flex items-center gap-8">
            <Link href="/" aria-label="AITRANSIT Cargo — home">
              <BrandLockup />
            </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              {signedIn ? (
                /* /app/dashboard, not /portal, even for a customer. The cookie
                   this reads says somebody is signed in and deliberately says
                   nothing about who — see the note on STAFF_HINT in
                   middleware.ts — and the middleware redirects a customer from
                   /app to their portal on arrival. Guessing here would mean
                   guessing wrong for one of the two. */
