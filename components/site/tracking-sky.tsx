 ...
 * Lusaka, aircraft flying them, and a locator pulse over Lusaka. The
 ...
 * business's customers ever load, on Zambian mobile data, and it must not
...
const ZAMBIA = project(39.28, -6.79);
...
/** Quadratic arc from a lane's origin to Lusaka, bowed off the straight chord. */
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      {/*
        ...
        Lusaka — the one place on the map the page is about. The map now
        fits its box whole, and the box is what moves between breakpoints.
        The extra 34 units of viewBox are headroom for the ZAMBIA ES SALAAM label,
      ...
      */}
      {/*
        ...
        gets clipped. Which is how Lusaka ended up below the fold twice.
      ...
      */}
      ...
      >
        ...
        <circle cx={ZAMBIA[0]} cy={ZAMBIA[1]} r="92" fill="url(#tsky-dar)" />
        ...
        {/* Lusaka, pinging. This is the tracking motif: the page is
        ...
        <circle
          ...
          className="sky-ping"
        />
        <circle cx={ZAMBIA[0]} cy={ZAMBIA[1]} r="4.5" fill="hsl(3 84% 58%)" filter="url(#tsky-soft)" />
        <text
          x={ZAMBIA[0]}
          y={ZAMBIA[1] + 20}
          textAnchor="middle"
      ...
      {/* Light at the top edge only. A bottom scrim strong enough to blend the
          hero into the page was also strong enough to swallow Lusaka,
