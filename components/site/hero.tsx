        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.02fr_minmax(0,0.98fr)] lg:gap-8 xl:gap-14">
          ...
          <div>
            ...
            <h1 className="rise rise-1 mt-6 font-display text-3xl font-extrabold leading-[1.08] tracking-tight sm:text-4xl lg:text-5xl">
              Air cargo from China to Lusaka, with{" "}
              <span className="text-info">duty included</span>
            </h1>
            ...
            {/* The three qualities as a gold rule under the headline. Kept
                to three words each — this line is scanned, not read. */}
            ...
            <p className="rise rise-2 mt-6 max-w-xl text-lg leading-relaxed text-white/75">
              We find your goods, pay your suppliers and fly your cargo out of
              Guangzhou and Hong Kong — the price you are quoted covers freight
              and duty all the way to our Lusaka warehouse.
            </p>
            ...
            <ul className="rise rise-4 mt-9 grid grid-cols-1 gap-x-8 gap-y-3 border-t border-white/10 pt-7 sm:grid-cols-2">
              {[
                ...
                /* AITRANSIT's actual differentiator, and the line the flyer
                   leads on: the price quoted is the price landed, duty
                   included. "Customers on Instagram" was a Target Express
                   proof point and AITRANSIT has no such following to claim. */
                { icon: Plane, label: "Freight and duty included to Lusaka" },
              ].map(({ icon: Icon, label }) => (
                <li
                  key={label}
