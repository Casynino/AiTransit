 ...
 * The route network.
 *
 * Four lanes converging on Lusaka, each with its own aircraft flying it.
 ...
 * Android on Zambian mobile data, which is what most of this site is read on.
...
/** Quadratic arc from a lane's origin to Lusaka, bowed by `bow`. */
    ...
    <section className="section relative overflow-hidden border-y bg-[hsl(var(--ink))] text-white">
      ...
      <div className="container relative">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.85fr_1.minmax(0,15fr)]">
          <div>
            <p className="eyebrow-gold">Our routes</p>
            ...
            <p className="mt-4 max-w-md text-white/65">
              Your cargo is received, weighed and photographed at our Guangzhou
              warehouse — then it flies.
            ...
            <ul className="mt-8 space-y-2.5 border-t border-white/10 pt-6">
              {LANES.map((lane) => (
                <li key={lane.id} className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-white/55">Lusaka</span>
                  {lane.main ? (
          ...
          <div className="relative">
            <svg
              ...
              role="img"
              aria-label="Air cargo routes into Lusaka from Guangzhou, Hong Kong, Dubai and Addis Ababa"
            >
              <defs>
                {LANES.map((lane) => (
                  <linearGradient
              ...
              <g>
                <circle
                  ...
                  className="dar-pulse"
                />
                <circle cx={ZAMBIA[0]} cy={ZAMBIA[1]} r="8" fill="hsl(var(--brand))" />
                <circle
                  cx={ZAMBIA[0]}
                  cy={ZAMBIA[1]}
                  r="16"
      ...
      <style>{`
        .dar-pulse {
          animation: zambiaPulse 3.5s ease-in-out infinite;
          transform-origin: ${ZAMBIA[0]}px ${ZAMBIA[1]}px;
        }
        @keyframes zambiaPulse {
