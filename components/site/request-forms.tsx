      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div>
          ...
          <select id="b-category" name="cargoCategory" className={field}>
            ...
            <option value="WIGS">Electronics</option>
            <option value="SPECIAL_CATEGORY">Liquids &amp; special</option>
          </select>
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className={labelClass} htmlFor="b-wanted">
            Needed in Lusaka by <span className="text-white/40">(optional)</span>
          </label>
