...
/*
  ...
  a kwacha cost has to be valued in dollars at the published rate before it
  can be added to a dollar cost, and that conversion is the part worth testing.
*/
const COSTS = [
  { desc: "Lusaka port and terminal handling", cat: "PORT_CHARGES", amount: "1850000", ccy: "ZMW" },
  { desc: "Customs duty on the consignment", cat: "CUSTOMS_DUTY", amount: "980", ccy: "USD" },
  { desc: "Clearing agent fee", cat: "CLEARING_AGENT", amount: "620000", ccy: "ZMW" },
  { desc: "Port to warehouse transport", cat: "LOCAL_TRANSPORT", amount: "310000", ccy: "ZMW" },
...
for (const cost of COSTS) {
  ...
  /*
    ...
    "Lusaka port and terminal handling1850000" and an empty amount, and then
