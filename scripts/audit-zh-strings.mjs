...
/*
  ...
  brand is a brand, a tracking number is an identifier, and a customer in Lusaka
...
const KEEP = [
  ...
  /^(Target|Express|AITRANSIT)$/i,
  /^(USD|K|CNY|RMB|kg|KG|QR|PDF|ID|OK|CEO|Admin)$/,
  /^AT-\d+/, /^[A-Z]{2}\/\d{2}-\d+$/,       // tracking and batch codes
  /^\/app\//,                                // route paths
