/**
 * Lusaka Warehouse — staff training manual.
 * English + Kiswahili, every line.
 */

export default {
  department: ["Lusaka Warehouse", "Ghala la Lusaka"],
  version: "1.0",
  labels: {
  ...
  audience: "Lusaka floor and counter staff",
  issued: "August 2026",
  ...
  sections: [
    {
      title: ["Welcome to the Lusaka floor", "Karibu kwenye ghala la Lusaka"],
      blurb: [
      ...
      pages: [
        {
          ...
          keys: [
            { n: 1, title: ["Email", "Barua pepe"], body: ["Your work email, e.g. warehouse@aitransit.co.zm.", "Barua pepe yako ya kazi, mfano warehouse@aitransit.co.zm."] },
            ...
            { n: 3, title: ["Sign in", "Ingia"], body: ["Takes you to the Lusaka floor home screen.", "Inakupeleka kwenye ukurasa wa ghala la Lusaka."] },
          ],
          callout: {
            kind: "tip",
            text: [
          ...
          blocks: [
            {
              ...
              steps: [
                ...
                { who: ["In the air", "Angani"], what: ["China → Zambia", "China → Zambia"], tone: "owed" },
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  ...
                  [
                    "You print it and work down the sheet. AT-000042 is two cartons, 3.6 kg, shoes.",
                    "Unaichapisha na kufuata orodha. AT-000042 ni maboksi mawili, kilo 3.6, viatu.",
                  ],
                ],
                [
                  ["Check in", "Ukaguzi"],
...

    {
      ...
      pages: [
        {
          title: ["The Lusaka floor in one page", "Ghala la Lusaka kwa ukurasa mmoja"],
