      ...
      pages: [
        {
          ...
          keys: [
            { n: 1, title: ["Email", "Barua pepe"], body: ["e.g. finance@aitransit.co.zm", "mfano finance@aitransit.co.zm"] },
      ...
      pages: [
        {
          ...
          keys: [
            ...
            { n: 2, title: ["The money, right now", "Hali ya pesa kwa sasa"], body: ["Owed to us, and collected today. Kwacha lead; the dollar figure is what the invoice says.", "Tunachodai, na kilichokusanywa leo. Shilingi zinaongoza; kiasi cha dola ndicho kilicho kwenye ankara."] },
          ...
          blocks: [
            {
              ...
              steps: [
                ...
                { who: ["Lusaka floor", "Ghala la Lusaka"], what: ["Checked in against the manifest", "Unakaguliwa kwa orodha ya mizigo"], tone: "owed" },
          ...
          blocks: [
            {
              ...
              fields: [
                ...
                { k: ["Tracking", "Namba ya ufuatiliaji"], v: "AT-000042" },
            ...
            },
            {
              ...
              rows: [
                [["Draft appears", "Rasimu inatokea"], ["Lusaka checks the cargo in. The system prices it: 3.6 kg × USD 13.50 = USD 48.60, as a DRAFT.", "Lusaka wanakagua mzigo. Mfumo unapanga bei: kilo 3.6 × USD 13.50 = USD 48.60, kama RASIMU."]],
                ...
                [["Customer pays", "Mteja analipa"], ["John sends USD 48.60 by mobile money. Customer Care submits the claim with his screenshot.", "John anatuma USD 48.60 kwa mobile money. Huduma kwa Wateja wanawasilisha dai pamoja na picha yake."]],
                [["You verify", "Unathibitisha"], ["You open the proof, match it to the mobile money account, and press Verify. A receipt is numbered and the ledger is posted.", "Unafungua ushahidi, unaulinganisha na akaunti ya mobile money, na kubonyeza Thibitisha. Risiti inapewa namba na daftari linaandikwa."]],
