...
export default {
  ...
  sections: [
          ...
          blocks: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  body: [
                    "See any price · scan a box (that is Lusaka's) · receive an arriving flight · release cargo to a customer · raise a claim · edit or delete cargo that has already left China.",
      ...
      pages: [
        {
          ...
          intro: [
            "Open the address in any browser — phone or computer. Type the email your admin gave you and your password, then press Sign in. If the password is refused twice, ask your admin to reset it rather than guessing; repeated failures are recorded. This page is in English because nobody has signed in yet, so the system does not know whose language to use. Once you sign in it switches to Chinese by itself.",
          ...
          keys: [
            {
              ...
              title: ["Email", "邮箱"],
              body: [
                "Your work email, e.g. china@aitransit.co.zm. Not a personal address.",
                "你的工作邮箱，例如 china@aitransit.co.zm。不要使用个人邮箱。",
              ],
            },
            {
              n: 2,
        ...
        },
        {
          ...
          callout: {
            kind: "warn",
            text: [
              "What you *type* is not translated by this switch. If you write a cargo description in Chinese, the system keeps your Chinese exactly as written and shows Lusaka an English rendering beside it. Neither desk is ever handed the other's language.",
      ...
      pages: [
        {
          ...
          keys: [
            {
              ...
              body: [
                "Your name, the department badge, and both clocks — China time and Zambia time. The clocks matter: a flight time quoted in the wrong one is a missed flight.",
          ...
          callout: {
            kind: "warn",
            text: [
              "A consignment with *no photograph* is always the most urgent row. It is registered but has nothing to argue with — if Lusaka reports it damaged, there is no picture of what it looked like when it left you.",
          ...
          keys: [
            {
              ...
              body: [
                "AT-000125, a carton reference like GZ/26-28-7, part of a customer's name, or a phone number in any of the forms people write it.",
                "AT-000125、类似 GZ/26-28-7 的箱号、客户姓名的一部分，或任意书写格式的电话号码。",
              ],
            },
            {
              n: 2,
              ...
              body: [
                "No prices and no camera scanner. Scanning belongs to the Lusaka counter; this desk prints labels and never reads them.",
    ...
    // ---------------------------------------------------------------- 06
    {
      ...
      blurb: [
        "One box, from a supplier in Guangzhou to a customer's hands in Lusaka.",
          ...
          blocks: [
            {
              ...
              steps: [
                ...
                { who: ["In the air", "空运中"], what: ["China → Zambia", "中国 → 坦桑尼亚"], tone: "owed" },
                { who: ["Lusaka floor", "达市仓"], what: ["Flight lands, batch marked arrived", "航班落地，批次标记到达"], tone: "owed" },
                { who: ["Lusaka floor", "达市仓"], what: ["Check in against the manifest", "按舱单核对入库"], tone: "owed" },
                ...
                { who: ["Lusaka floor", "达市仓"], what: ["Scan · photograph · hand over", "扫码 · 拍照 · 交货"], tone: "paid" },
              ],
            },
          ],
        },
    ...
    // ---------------------------------------------------------------- 07
    {
      ...
      pages: [
        {
          title: ["AT-000042 · shoes for John Peter", "AT-000042 · John Peter 的鞋子"],
            ...
            },
            {
              ...
              rows: [
                [
                  ...
                  [
                    "John's boxes arrive. You search 0764 197 748, find him, pick *Normal goods*, weigh 3.6 kg, count 2 cartons, type 鞋子, take two photographs and save. The system creates AT-000042 and two labels: AT-000042-P1 and -P2.",
                    "John 的货到了。你搜索 0764 197 748 找到他，选择*普通货物*，称得 3.6 公斤，数出 2 箱，填写“鞋子”，拍两张照片并保存。系统生成 AT-000042 及两张标签：AT-000042-P1 和 -P2。",
                  ],
                ],
                [
                  ["Labels", "贴标"],
                ...
                [
                  ["Dispatch", "发运"],
                  [
                    "You seal the table with waybill 176-44821905 on Ethiopian Airlines ET605. AT-000042 is now beyond your reach.",
                    "你以空运单号 176-44821905、埃塞俄比亚航空 ET605 封批。此后 AT-000042 你无法再修改。",
                  ],
                ],
                [
                  ["Lusaka", "达市"],
                ...
                [
                  ["Collected", "提货"],
                  [
                    "John comes to the counter. The clerk scans one carton, both boxes are accounted for, a handover photo is taken, and AT-000042 is delivered.",
                    "John 到柜台。柜员扫描其中一箱，两箱都核对齐全，拍摄交接照片，AT-000042 完成交付。",
                  ],
                ],
              ],
            },
          ...
          blocks: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  body: [
                    "Your Chinese is kept exactly as written, and Lusaka is shown an English rendering beside it.",
