  ...
  sections: [
    {
      ...
      blurb: [
        "One seat answers for Guangzhou, the Lusaka floor, Finance and Customer Care at once.",
      ...
      pages: [
        {
          ...
          keys: [
            { n: 1, title: ["Email", "邮箱"], body: ["e.g. ceo@aitransit.co.zm", "例如 ceo@aitransit.co.zm"] },
      ...
      pages: [
        {
          ...
          keys: [
            ...
            },
            {
              ...
              body: [
                "One bounded, filterable panel grouped by the desk that owns the fix — Guangzhou, Lusaka floor, Finance, Support, Cases — ranked critical, warning, info. It never grows into an endless stack.",
            ...
            },
            {
              ...
              body: [
                "Four cards: Guangzhou, the Lusaka floor, Finance, Customer Care. *Read the problem line, not just the figure.* A high number with no problem line is a busy desk working properly.",
            ...
            },
            {
              ...
              body: [
                "Revenue this month, outstanding, delivered, and the three-day promise. Kwacha lead; the dollar figure is what the invoice says.",
      ...
      pages: [
        ...
        },
        {
          ...
          callout: {
            kind: "tip",
            text: [
              "New Guangzhou accounts open in Chinese automatically; every Zambian desk opens in English. Whatever the person chooses afterwards is stored against them and wins.",
        ...
        },
        {
          ...
          intro: [
            "Collection accounts, the Zambia and China office addresses, and the contact numbers. Pricing is the rate book every quote comes from — change a figure there and cargo, invoices, tracking and reports all follow.",
          ...
          blocks: [
            {
              ...
              steps: [
                ...
                { who: ["Lusaka floor", "达市仓"], what: ["Land and check in the flight", "接收并核对航班"], tone: "owed" },
...

    {
      ...
      pages: [
        {
          title: ["AT-000042 · a claim and a cost", "AT-000042 · 一次索赔与一笔支出"],
            ...
            },
            {
              ...
              rows: [
                [
                  ...
                  [
                    "The Lusaka floor cannot find one of John's two cartons. They press 'Unable to locate', write where they looked, and a case opens automatically. You are notified; they are not able to decide it.",
          ...
          blocks: [
            {
              ...
              rows: [
                ...
                [["Comparing a kwacha card with a dollar card", "先令卡片与美元卡片相比"], ["A conclusion out by a factor of thousands.", "结论会相差上千倍。"], ["Kwacha lead; the dollar figure is what the invoice says.", "以先令为主；美元金额是账单上的数字。"]],
