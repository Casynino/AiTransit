...
export default {
  ...
  sections: [
      ...
      pages: [
        {
          ...
          keys: [
            { n: 1, title: ["Email", "Barua pepe"], body: ["e.g. support@aitransit.co.zm", "mfano support@aitransit.co.zm"] },
      ...
      pages: [
        {
          ...
          intro: [
            "Every consignment sitting in Lusaka that is already billed and not yet paid, with a phone number on the row. Read the *Next action* column before you dial — a row that says “Confirm the price” means the invoice is still a draft.",
            "Kila mzigo uliopo Lusaka ambao umeshatozwa na haujalipwa, na namba ya simu kwenye mstari. Soma safu ya *Hatua Inayofuata* kabla ya kupiga — mstari unaosema “Thibitisha bei” maana yake ankara bado ni rasimu.",
          ],
          ...
          keys: [
            ...
            },
            {
              ...
              body: [
                "The Swahili reminder is already written: name, tracking number, goods, invoice, weight, amount in kwacha and where to pay.",
        ...
        },
        {
          ...
          keys: [
            { n: 1, title: ["The reference", "Namba ya kumbukumbu"], body: ["The mobile money or bank reference the customer gives you.", "Namba ya mobile money au benki mteja anayokupa."] },
          ...
          blocks: [
            {
              ...
              steps: [
                ...
                { who: ["Lusaka floor", "Ghala la Lusaka"], what: ["Checked in against the manifest", "Unakaguliwa kwa orodha ya mizigo"], tone: "draft" },
                ...
                { who: ["Lusaka floor", "Ghala la Lusaka"], what: ["Scan · photograph · hand over", "Skani · piga picha · kabidhi"], tone: "paid" },
              ],
            },
          ],
        },
...

    {
      ...
      pages: [
        {
          title: ["AT-000042 · shoes for John Peter", "AT-000042 · viatu vya John Peter"],
          ...
          blocks: [
            {
              ...
              fields: [
                ...
                { k: ["Tracking", "Ufuatiliaji"], v: "AT-000042" },
            ...
            },
            {
              ...
              rows: [
                [["Row appears", "Mstari unatokea"], ["Finance confirms the price. AT-000042 lands on your call list with 'Ring them' in the Next action column.", "Fedha wanathibitisha bei. AT-000042 unatokea kwenye orodha yako ya simu na 'Mpigie simu' kwenye safu ya Hatua Inayofuata."]],
                [["You ring", "Unapiga simu"], ["You press the WhatsApp icon. The Swahili reminder is pre-written with his name, AT-000042, shoes, the invoice number and the amount in kwacha.", "Unabonyeza alama ya WhatsApp. Ujumbe wa Kiswahili umeshaandikwa na jina lake, AT-000042, viatu, namba ya ankara na kiasi kwa shilingi."]],
                [["He pays", "Analipa"], ["John sends the money by mobile money and forwards you the confirmation screenshot.", "John anatuma pesa kwa mobile money na kukutumia picha ya uthibitisho."]],
                [["You record it", "Unaiandika"], ["You open the payment icon on his row, type the mobile money reference, attach his screenshot, and hand it up. Nothing has settled yet.", "Unafungua alama ya malipo kwenye mstari wake, unaandika namba ya mobile money, unaambatisha picha yake, na kuwasilisha. Bado hakuna kilichokamilika."]],
                [["Finance verifies", "Fedha wanathibitisha"], ["They match the proof to the mobile money account and verify. A receipt is numbered and the pickup note is issued.", "Wanalinganisha ushahidi na akaunti ya mobile money na kuthibitisha. Risiti inapewa namba na hati ya kuchukua inatolewa."]],
