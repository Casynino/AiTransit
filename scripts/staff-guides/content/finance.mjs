...
export default {
  brand: "AITRANSIT Cargo",
  department: "Finance",
  shortName: "The money desk",
  title: "The money desk",
  route: ["Guangzhou", "Lusaka"],
  lede:
    "Everything this business is owed passes through your screen, and no cargo leaves the Lusaka warehouse until you say it has been paid for. This is what to do when you sign in — in the order to do it.",
  ...
  authorities: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          "The Lusaka counter cannot hand over boxes without a pickup note, and only Finance can issue one. When you issue it, cargo moves. When you do not, it stays.",
      },
    ],
  },
  ...
  steps: [
      ...
      screen: {
        ...
        blocks: [
          { type: "label", text: "The money · right now" },
          {
            type: "big",
            items: [
              { label: "Owed to us", value: "K 25,409,700", tone: "owed" },
              { label: "Collected today", value: "K 510,300", tone: "paid" },
            ],
          },
          { type: "rule" },
    ...
    },
    {
      ...
      body: [
        "When cargo lands in Lusaka the system prices it automatically and files it as a *draft*. A draft is a working figure — nobody has been asked for it and nobody owes it yet.",
      ...
      screen: {
        name: "Batch B-2026-014 — Guangzhou → Lusaka",
        blocks: [
          {
            type: "kv",
            items: [
          ...
          { type: "rule" },
          {
            type: "queue",
            items: [
              { text: "AT-000105 · 24.5 kg", value: "USD 39.15", pill: { text: "Draft", tone: "draft" } },
              { text: "AT-000106 · 8.0 kg", value: "USD 14.40", pill: { text: "Draft", tone: "draft" } },
            ],
          },
        ...
        blocks: [
          {
            type: "kv",
            items: [
              { label: "Customer", value: "Japhet Lihanjala", sub: "AT-000105 · INV-2026-000002" },
        ...
        blocks: [
          ...
          { type: "rule" },
          {
            ...
            items: [
              ...
              { label: "Into which account", value: "mobile money · Business" },
            ],
          },
          {
            type: "queue",
    ...
    },
    {
      ...
      body: [
        "This is the most important thing this desk does. Until the note exists, the Lusaka counter *physically cannot* release the boxes — it scans the carton and the screen refuses.",
      ],
      caution:
        ...
        blocks: [
          {
            ...
            items: [
              {
                text: "PN-2026-000001",
                sub: "AT-000105 · Japhet Lihanjala · 3 packages",
          ...
          {
            type: "queue",
            items: [{ text: "Lusaka warehouse can now scan and release", tone: "paid", pill: { text: "Cleared", tone: "paid" } }],
          },
        ],
      },
    },
        ...
        blocks: [
          {
            type: "big",
            items: [
              { label: "Total outstanding", value: "K 25,409,700", tone: "owed" },
              { label: "Over 30 days", value: "K 3,120,000", tone: "signal" },
            ],
          },
          { type: "rule" },
          {
            type: "queue",
            items: [
              { text: "Grace Banda · +260 977 ···", sub: "AT-000098 · 34 days", value: "USD 208.00", tone: "signal" },
              { text: "Chanda Mulenga · +260 966 ···", sub: "AT-000101 · 12 days", value: "USD 76.50", tone: "owed" },
            ],
          },
        ],
      },
