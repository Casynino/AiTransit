...
export default {
  ...
  lede:
    "This is the one chair that answers for Guangzhou, the Lusaka floor, Finance and Customer Care at once. It exists to read the whole business on one screen and to sign off the decisions nobody else may take — not to run the daily operation. If you find yourself doing another desk's work, something upstream has gone wrong.",
  ...
  steps: [
    ...
    },
    {
      ...
      body: [
        "One bounded, filterable panel, grouped by the desk that owns the fix — Guangzhou, Lusaka floor, Finance, Customer Care, Cases — and ranked critical, warning, info.",
        ...
        blocks: [
          {
            type: "queue",
            items: [
              { text: "Claim AT-000126 · payout awaiting approval", sub: "Cases", pill: { text: "Critical", tone: "signal" } },
              ...
              { text: "5 past the free storage window", sub: "Lusaka floor", pill: { text: "Info", tone: "plain" } },
            ],
          },
        ],
      },
    },
    {
      ...
      body: [
        "Four cards: Guangzhou (registered and waiting to fly, flagging anything unphotographed), the Lusaka floor (what is standing, flagging anything past the free storage window), Finance (bills unpaid and money waiting to be checked), and Customer Care (tickets and calls owed).",
      ],
      caution:
    ...
    },
    {
      ...
      screen: {
        name: "Issues & Claims — AT-000126",
        blocks: [
          {
            type: "kv",
            items: [
              { label: "Case", value: "Missing · 1 carton" },
              { label: "Raised by", value: "Lusaka floor" },
    ...
    },
    {
      ...
      caution:
        "*The two bases always disagree, and both are true.* Quoting the cash figure as profit in a month with a big collection is how a bad month reads as a good one. Also: kwacha lead, with the dollar figure underneath — never read one card in dollars against another in kwacha.",
    },
    {
      n: 7,
      state: "paid",
        ...
        blocks: [
          {
            type: "queue",
            items: [
              { text: "Payout approved · AT-000126", sub: "You · 14:22", value: "USD 180.00" },
  ...
  mistakes: [
    ...
    {
      mistake: "Comparing a kwacha card with a dollar card",
      consequence: "A conclusion out by a factor of thousands.",
      correct: "Kwacha lead; the dollar figure is what the invoice says.",
    },
    {
