...
export default {
  ...
  lede:
    "Every record in this system starts on your bench. You take the boxes in, weigh them, photograph them, register them, print the code that travels with them, and put them on a flight. Everything Lusaka, Finance and the customer ever see is what you typed — which is why this desk gets the most care.",
    ...
    items: [
      {
        ...
        body:
          "Registering mints the tracking number, one QR-bearing label per box, the first line of history and the loading table it belongs on. *Nobody re-types this later.* Lusaka checks against it, Finance bills from it, the customer tracks it.",
      },
      {
        label: "You never see",
        tone: "signal",
  ...
  cannotDo: [
    ...
    "Scan a box; the camera scanner belongs to Lusaka",
    "Receive or check in an arriving flight — that is Lusaka's bench",
  ...
  steps: [
    {
      ...
      caution:
        "*A consignment with no photograph is the urgent one.* It is registered but has nothing to argue with — if Lusaka says a box arrived damaged, there is no picture of what it looked like when it left you.",
      screen: {
    ...
    },
    {
      ...
      body: [
        ...
        "You may type the description in Chinese. The system keeps exactly what you typed *and* an English rendering beside it, so Lusaka reads English and you keep your own words.",
      ],
      caution:
    ...
    },
    {
      ...
      body: [
        ...
        "You are the only desk that can print these. Lusaka cannot make another one.",
      ],
      caution:
  ...
  guardrails: [
    ...
    },
    {
      ...
      body: "Once a table is dispatched, every piece on it is beyond editing or deleting from this desk. There is no undo, by design — the manifest Lusaka checks against must be the one that flew.",
    },
    {
      label: "Your own words",
      title: "Chinese is never overwritten",
      body: "What you type is kept exactly as you typed it, with an English rendering stored beside it. Lusaka reads English; you keep your own words on the record.",
    },
  ],
  guardrailNote:
