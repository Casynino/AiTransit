/** Lusaka warehouse — physical custody in Zambia. Role: ZAMBIA_WAREHOUSE. */

export default {
  brand: "AITRANSIT Cargo",
  department: "Lusaka Warehouse",
  shortName: "The Lusaka floor",
  title: "The Lusaka floor",
      ...
      screen: {
        ...
        blocks: [
          ...
          { type: "rule" },
          {
            type: "queue",
            items: [
              { text: "AT-000121 · 6 cartons", pill: { text: "Received", tone: "paid" } },
              { text: "AT-000124 · 2 cartons", sub: "photo + severity required", pill: { text: "Damaged", tone: "signal" } },
              { text: "AT-000126 · 1 carton", pill: { text: "Missing", tone: "signal" } },
            ],
          },
        ],
      },
