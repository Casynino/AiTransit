...
export default {
  ...
  steps: [
        ...
        blocks: [
          {
            type: "kv",
            items: [
              { label: "Customer", value: "Neema Kileo", sub: "AT-000112 · INV-2026-000019" },
    ...
    },
    {
      ...
      body: [
        "Every consignment sitting in Lusaka that is already billed and not yet paid, with a phone number on the row.",
        ...
        blocks: [
          {
            ...
            items: [
              {
                text: "Grace Banda · +260 977 ···",
                sub: "AT-000098 · 34 days · Next action: Ring them",
                value: "USD 208.00",
                tone: "signal",
              },
              {
                text: "Chanda Mulenga · +260 966 ···",
                sub: "AT-000101 · Next action: Confirm the price",
                value: "Draft",
                tone: "draft",
              },
            ],
    ...
    },
    {
      ...
      body: [
        "The Swahili reminder is already composed for you: the customer's name, tracking number, goods, invoice number, weight, the amount in kwacha and where to pay.",
