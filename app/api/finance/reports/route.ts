...
export async function GET(request: Request) {
  ...
  /*
    ...
    every time somebody asked for kwacha.
  */
  const unit = params.get("unit") === "zmw" ? "ZMW" : "USD";
  ...
  */
  if (params.get("format") === "pdf") {
    ...
    return new NextResponse(pdf, {
      headers: {
        ...
        "content-disposition": `inline; filename="aitransit-${key}-${stamp}.pdf"`,
  ...
  return new NextResponse(reportToCsv(report), {
    headers: {
      ...
      "content-disposition": `attachment; filename="aitransit-${key}-${stamp}.csv"`,
