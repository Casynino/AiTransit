...
export const metadata: Metadata = {
  ...
  description:
    "AITRANSIT operates its own warehouse in Guangzhou and its own office in Lusaka. Every piece of cargo is weighed, photographed and labelled by our own staff.",
};
...
const HANDLING = [
  ...
  },
  {
    ...
    body: "Each physical box gets its own code. Five cartons means five labels, so a missing one is visible immediately rather than at the counter in Lusaka.",
  },
  {
    icon: ClipboardCheck,
    title: "Checked against a manifest on arrival",
    body: "In Lusaka the whole batch is checked piece by piece against a printed list. Anything short is flagged there, not weeks later.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        body={<>Not an agent&apos;s address, not a shared depot. Your cargo is handled by people who work for us, in Guangzhou and in Lusaka.</>}
      />
      ...
      <MediaBand
        ...
        body="What our staff consolidate in Guangzhou is what our staff check in when it lands in Lusaka. Nobody else handles it in between."
      />
      ...
      <section className="section relative isolate border-y bg-muted/30">
        ...
        <div className="container">
          ...
          <p className="mt-8 max-w-3xl rounded-xl border bg-card p-5 text-sm text-muted-foreground">
            ...
            is not long-term warehousing, and cargo sitting in Lusaka after it has
