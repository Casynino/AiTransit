...
export const metadata: Metadata = {
  ...
  description:
    "AITRANSIT flies cargo from Guangzhou to Lusaka every Wednesday, Friday and Sunday. See the next departures and their cut-off days.",
};
...
export default function SchedulePage() {
  ...
  return (
    ...
    <PageHero
      ...
      body="Guangzhou to Lusaka every Wednesday, Friday and Sunday. Get your cargo to our warehouse by the cut-off day and it goes on that flight."
    />
