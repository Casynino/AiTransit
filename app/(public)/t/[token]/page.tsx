 ...
 * Makeni points a phone at the box and reads the whole journey, with no app
 * and no login.
 *
 ...
 * is what the Lusaka counter scans before releasing a box, and a code somebody
 * could derive from AT-000042 would be a way to claim the next customer's
 * cargo.
 *
