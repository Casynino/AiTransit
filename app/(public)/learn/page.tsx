...
export const metadata: Metadata = {
  ...
  description:
    "Plain guides to importing from China to Zambia: how air cargo works, why weight is charged the way it is, choosing suppliers, packing, paying and clearing customs.",
};
