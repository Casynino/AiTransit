...
export const metadata: Metadata = {
  ...
  description:
    "The AITRANSIT warehouse address in Guangzhou, in Chinese and English — send it to your supplier so they can deliver your cargo.",
};
...
const MARKINGS = [
  ...
  },
  {
    ...
    body: "The Zambian number you use with us — this is how we find you in the system.",
  },
  {
    icon: Package,
    // The units a supplier writes on a packing list and a trader reads on an
    // invoice, in the words printed on the carton itself — slashes rather than
    // "or" to match the shipping-mark card above, which already reads as an
    // either/or.
    title: "Quantity — PCS / PACKAGE / CTN",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        eyebrow="Our China warehouse address"
        /* The owner's own wording — the words customers of this business use
           with their own suppliers. */
        title="Send your supplier this address"
        body={
          <>
            Send this address to your supplier on WeChat or WhatsApp. It is in
            Chinese because that is what their driver reads at our gate.
            <span className="mt-2 block text-sm text-white/55">
              Send this address to your supplier in China. They deliver your
              cargo to us, and we fly it to Lusaka.
            </span>
          </>
        }
        aside={
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            <h2 className="rule-gold font-display text-2xl font-bold tracking-tight sm:text-3xl">
              Ask your supplier to mark the boxes like this
            </h2>
      ...
      <section className="section relative isolate">
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl rounded-2xl border border-warning/40 bg-warning/5 p-6 shadow-soft backdrop-blur sm:p-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Airlines and Zambian customs prohibit these. If you are not sure,
      ...
      {/* Zambia side — the page closes on the other end of the route.
          Everything inside this band is explicitly white-on-ink, because
          MediaBand is a dark section. */}
      <MediaBand
        image={IMAGES.apron}
        title="Ofisi zetu Zambia"
        body="This is where you collect your cargo once it has landed."
      >
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          >
            <Link href="/track">Track your cargo</Link>
          </Button>
          <Button
            asChild
            variant="outline"
