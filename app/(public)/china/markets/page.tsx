...
export const metadata: Metadata = {
  ...
  description:
    "The wholesale markets Zambian traders buy from in China — what each one sells, where it is, and how the goods fly home with AITRANSIT.",
};
  ...
  return (
    <>
      ...
      <MediaBand
        ...
        body="Tell us what you need and your budget. Our team finds the supplier, checks the goods, and ships them to Lusaka — you never leave Zambia."
      >
        <div className="flex flex-wrap justify-center gap-3">
          <Button asChild size="lg" className="rounded-xl">
            <a
              href={`https://wa.me/${COMPANY.whatsapp}?text=${encodeURIComponent(
                "Hello AITRANSIT, I would like help sourcing goods from China."
              )}`}
              target="_blank"
