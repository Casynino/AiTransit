...
export const metadata: Metadata = {
  ...
  description:
    "Cannot travel to China? AITRANSIT finds the supplier, checks the goods and ships them to Lusaka — you never leave Zambia.",
};
...
const STEPS = [
  ...
  },
  {
    ...
    body: "From there it is normal AITRANSIT cargo: a tracking number, a QR code, and collection in Lusaka.",
  },
];
