...
/**
 * The card that appears when somebody pastes a AITRANSIT link.
 *
...
export const alt = `${COMPANY.name} — air cargo from China to Zambia`;
    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #0B1220 0%, #103B7C 62%, #24406F 100%)",
          padding: 64,
        }}
      >
        {/* The brand rule, in the proportion the logo uses its two inks. */}
        <div style={{ display: "flex", position: "absolute", top: 0, left: 0 }}>
          <div style={{ width: 300, height: 12, background: "#2BAEE6" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Air cargo from China to Zambia
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            Guangzhou · Hong Kong — Lusaka · {COMPANY.promiseDays} days
          </div>
        </div>
