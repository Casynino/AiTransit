...
/**
 * Available Cargo — what is physically standing in the Lusaka warehouse now.
 *
 * "Now" is exactly two statuses: RECEIVED_AT_ZAMBIA (checked in off the manifest)
  ...
  return (
    <>
      <PageHeader
        ...
        description="Every piece of cargo standing in the Lusaka warehouse right now — checked in, not yet handed over."
      />
      ...
      {rows.length === 0 ? (
        <EmptyState
          ...
          description={t(
            locale,
            "Nothing is being held in Lusaka. Cargo appears here the moment it is checked in against a batch manifest."
          )}
        />
      ) : (
        <>
