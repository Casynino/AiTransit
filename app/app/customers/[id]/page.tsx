...
export default async function CustomerProfilePage({
  ...
  const templates = (
    ...
    body: composeMessage(kind, {
      ...
      // "en", never the viewer's locale: these are customer-facing messages for the
      // customer, and the customer is in Zambia. Resolved against the reader,
      // a Guangzhou desk opening a Lusaka customer to chase them composed the
        ...
        actions={
          customer.phone ? (
            <>
              ...
              <a
                href={whatsappLink(customer.phone, `Hello ${customer.name.split(" ")[0]},`)}
                target="_blank"
            ...
            ? [
                {
                  ...
                  // Kwacha first: this is the figure quoted down the phone.
                  value: profileRate
                    ? `ZMW ${Math.round(stats.outstanding * profileRate).toLocaleString("en-US")}`
                ...
                },
                {
                  ...
                  value: profileRate
                    ? `ZMW ${Math.round(stats.lifetimeValue * profileRate).toLocaleString("en-US")}`
