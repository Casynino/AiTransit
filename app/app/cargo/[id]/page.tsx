...
export default async function ShipmentDetailPage({
  ...
  /*
    ...
    Two dates decide everything: when it landed in Lusaka and whether it has been
        ...
        actions={
          <>
            ...
            {/* The status says where the cargo is; this says what is wrong
                with it. Damaged cargo is still "Received at Lusaka", so the two
            ...
            {/* Offered only while the record can actually be changed — a
                ...
                admin was shown no Edit button on cargo already in the air. */}
              ...
              shipment.invoice && shipment.invoice.status !== "DRAFT"
                ? whatsappLink(
                    ...
                    composeMessage("INVOICE_ISSUED", {
                      ...
                      trackingNumber: shipment.trackingNumber,
                      // The message goes to a Zambian customer in English,
                      ...
                      // page put 手机配件 in front of somebody in Lusaka.
