 ...
 *
 * The overview card answers the questions a admin asks standing up — how big,
...
export default async function ShipmentPage({
  ...
  const [finance, unpaidWeight, costBreakdown, owing, carryTargets, carriedIn] =
    await Promise.all([
      ...
      /*
        ...
        too: they hold cargo that has not left China, and a Lusaka debt does not
        belong on one.
  ...
  */
  ...
  const timeline: TimelineEntry[] = [
    ...
    {
      id: "expected",
      label: t(locale, "Expected in Lusaka"),
      detail: dispatch.expectedArrival
        ? t(locale, "What Lusaka was told to expect")
    ...
    },
    {
      ...
      detail: dispatch.arrivedAt
        ? t(locale, "Confirmed by the Lusaka warehouse")
  ...
  return (
    <>
      <PageHeader
        ...
        description={`${t(locale, ORIGIN_LABELS[dispatch.origin])} → ${t(locale, "Lusaka")}`}
        /*
