...
export default async function DeletedRecordsPage() {
  ...
  /*
    ...
    Getting in is shipment.cancel — the owner and the admin, since restoring a
    record and reading why it went are exactly the admin's job. Erasing one for
    good is shipment.purge, which is the owner's and nobody else's. The purge
    control was drawn on every row for whoever got through the door, so a admin
