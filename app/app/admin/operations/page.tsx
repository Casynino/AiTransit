 ...
 *
 * The admin's day is one question asked repeatedly — where has cargo stopped
 * moving, and who is it waiting on — and until now answering it meant opening
 * Guangzhou's floor, the receiving bench, the Lusaka warehouse and the support
 ...
 *
 * EVERY FIGURE IS A LINK INTO THE LIST THAT PROVES IT. A count a admin cannot
    ...
    <>
      ...
      */}
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
        ...
        <Leg leg={ops.zambia} role={user.role} locale={locale} icon={Warehouse}>
          {/* The end of the journey, and the only place a "closed" batch is
              named — a table in Guangzhou is emptied by being dispatched, and
              the books are shut here, after Lusaka has ticked every box off. */}
          {ops.lastClosed ? (
            <ProofRow
      ...
      {/*
        ...
        counter when somebody actually pays. A storage figure in kwacha on an
      ...
      */}
      <div className="mt-5">
        {/* No count chip. The chip means "this many rows below", and what a
            admin wants counted here is the whole overdue set — which is
            already the last figure in the Lusaka column. One number meaning two
      ...
      <div className="mt-5">
        ...
        {/* The company's own panel, rendered here rather than reworded: the
            admin and the owner must read the same sentence about the same
