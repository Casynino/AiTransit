...
const EXCEPTION_INCLUDE = {
  ...
  shipment: {
    select: {
      ...
      // way out: China's registration shots and the Lusaka floor's arrival shots
      // are what an investigation is decided by comparing.
      photos: PHOTO_SELECT,
      // Payment STATUS only. Lusaka never sees what anything cost, but "the
...
export default async function ExceptionsPage({
  ...
  // Read, not raise. Every department reaches this page — Lusaka found the
