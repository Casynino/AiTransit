...
import { formatKwacha, formatUsd } from "@/lib/fx";
    ...
    */
    amountLabel:
      credit === null
        ...
        : waived
          ? null
          : /* Kwacha lead, at THIS bill's own frozen rate — the customer was
               quoted a kwacha figure and it must not move with the market. */
            formatKwacha(
    ...
    credit:
      pendingCredit === null
        ...
        : {
            ...
            /* The dollars beside the kwacha, and only when the bill carries a
