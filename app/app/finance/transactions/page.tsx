...
export default async function LedgerPage({
  ...
  // or the mobile-money reference on the message, or roughly what the cargo was. Every one
  ...
  // in kwacha — the same conversion every other figure here uses.
          ...
          <Table>
            ...
            <TableBody>
              {entries.map((entry) => {
                ...
                // a browser will happily break a line inside AT-000104.
                const refs = [
                  entry.payment?.receipt?.receiptNumber ??
                    entry.expense?.expenseNumber ??
                    entry.transfer?.transferNumber ??
