...
/*
  ...
  Deliberately not shared with the admin's screen, which names the same five
  states in the words of the desk reading them — "With the admin" here is
  ...
  */
  ...
  return (
    <>
      <PageHeader
        title="Payroll"
        description="Build the month from the staff register, correct the exceptions, and send it to the admin. Nothing leaves the account until he has agreed it."
      />
      ...
      {run ? (
        <section className="mb-6 space-y-3">
          ...
          {/*
            The admin's reason, above everything else.
          ...
          */}
          ...
          {run.status === "APPROVED" ? (
            <p className="flex flex-wrap items-center gap-x-1.5 rounded-xl border border-brand/40 bg-brand/[0.05] p-2.5 text-[11px] text-brand">
              ...
              <span className="text-muted-foreground">
                {t(locale, "The money has not moved. The admin pays it, out of")}{" "}
